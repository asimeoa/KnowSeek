...
**Version: rev05_004 — Last updated: 24.03.2026 — Branch: main_sia06**
...
### 1.2 🔍 PartSeek.Ai — ✅ MVP
Describe a part in plain text and find the matching component in your parts library. Shows dimensions, material, strength values, and which OEM it applies to. Image search via LLaVA or YOLO planned. (Date not save).
...
```bash
cd 01_backend/modules/02_docseek
python ingest.py
```
...
| Component | Version | Status |
|-----------|---------|--------|
| Frontend UI | rev05_004 | ✅ Done — Port 8081 |
| FastAPI Backend | rev05_004 | ✅ Done — Port 8001 |
| Frontend ↔ Backend | rev05_004 | ✅ Connected via api.ts |
| Ollama + llama3 | 0.17.7 | ✅ Running |
| nomic-embed-text | 274MB | ✅ Installed |
| ChromaDB | 1.5.5 | ✅ Installed |
| rank-bm25 | 0.2.2 | ✅ Installed |
