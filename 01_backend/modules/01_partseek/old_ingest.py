...
def run_partseek_ingest(partseek_profile: str = "partseek_100"):
    """
    ...
    # Use auto profile: PartSeek files get partseek chunk profile,
    # DocSeek files keep docseek profiles in the same one-collection ingest.
    summary = run_ingest(config_name="auto", partseek_profile=partseek_profile)
